...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐋𝐚𝐛𝐞𝐭𝐢𝐧𝐞𝐳𝐳
  ${tradutor.texto1[2]} +56945343512
  ${tradutor.texto1[3]} https://www.instagram.com/vs_connie
  ...
  const Message = {
    document: { url: `https://www.instagram.com/vs_connie` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/vs_connie",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐋𝐚𝐛𝐞𝐭𝐢𝐧𝐞𝐳𝐳",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/vs_connie",
      },
    },
    caption: info,
    footer: wm,
